...
- `статистика` — среднее, медиана, стандартное отклонение числовых колонок
- `топ-N` — ранжирование по указанному полю
- `распределение` — гистограммы и круговые диаграммы категориальных данных
- `корреляции` — взаимосвязи между числовыми переменными
- `инсайты` — автоматическое выявление закономерностей в данных
